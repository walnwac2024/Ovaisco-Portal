...
export default function NewsModal({ isOpen, onClose, onSave, initialData = null }) {
    ...
    return (
        <div className="modal-overlay backdrop-blur-sm bg-slate-900/40 px-4">
            <div className="modal-content max-w-2xl max-h-[90vh] rounded-[32px] shadow-2xl border-none animate-in zoom-in-95 duration-300 flex flex-col">
                <div className="modal-header border-b-0 pb-2 px-8 pt-6 flex items-center justify-between flex-shrink-0">
                    <div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <div className="modal-body px-8 py-4 space-y-4 overflow-y-auto flex-1">
                    ...
                    <div className="px-8 py-4 border-t border-slate-100 bg-white rounded-b-[32px] flex-shrink-0">
